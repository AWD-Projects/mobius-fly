          ...
          >
            ...
            <div className="bg-surface rounded-md border border-border p-5 flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-body font-bold text-text tracking-widest">
                  {bookingRef}
                </p>
              </div>
            </div>
            ...
            <div className="bg-surface rounded-md border border-border p-5 sm:p-6 flex flex-col gap-4">
              ...
              <div className="grid grid-cols-2 gap-3 text-small">
                ...
                <div>
                  ...
                  <p className="text-text font-medium">
                    {fmtDate(flight.departureDatetime)}
                  </p>
                </div>
                <div>
                  <p className="text-muted mb-0.5">Horario</p>
                  <p className="text-text font-medium">
                    {fmtTime(flight.departureDatetime)} —{" "}
                    {fmtTime(flight.arrivalDatetime)}
                  </p>
                </div>
                <div>
              ...
              <div className="flex flex-col gap-2 text-small">
                <div className="flex justify-between">
                  ...
                  <span className="text-text">
                    ${fmtMXN(payment.basePrice)} MXN
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-muted">Cargo por servicio (5%)</span>
                  <span className="text-text">
                    ${fmtMXN(payment.passengerFeeAmount)} MXN
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-muted">IVA (16%)</span>
                  <span className="text-text">
                    ${fmtMXN(payment.vatAmountTotal)} MXN
                  </span>
                </div>
                ...
                <div className="flex justify-between font-semibold">
                  ...
                  <span className="text-text text-body">
                    ${fmtMXN(payment.amountTotalPaid)} MXN
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-surface rounded-md border border-border p-5 flex flex-col gap-1">
              ...
              <p className="text-small text-text font-medium">
