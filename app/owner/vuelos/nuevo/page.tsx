...
export default function CreateFlightPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    departureTime: "",
    departureDate: "",
    // Flight Info - Regreso (for redondo)
    returnOrigin: "",
    returnDestination: "",
    returnFboOrigin: "",
  ...
  const handlePublish = () => {
    console.log("Publishing flight:", formData);
    // Aquí iría la lógica para publicar el vuelo
  };
      ...
      <div className="px-12 py-8">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-sm text-muted">
            Configura y publica tu vuelo para que los compradores lo vean
          </p>
        </div>
      </div>
