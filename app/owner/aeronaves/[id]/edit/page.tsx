...
export default function EditAircraftPage() {
  ...
  // Load existing aircraft data or use defaults
  const existingAircraft = mockAircraftData[aircraftId] || {
    model: "",
    registration: "",
    year: "",
    seats: "",
  ...
  const handleUpdate = () => {
    console.log("Updating aircraft:", aircraftId, formData);
    // Aquí iría la lógica para actualizar la aeronave
    router.push(`/owner/aeronaves/${aircraftId}`);
  };
      ...
      <div className="px-12 py-8">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-sm text-[#666666]">
            Modifica la información de tu aeronave
          </p>
        </div>
      </div>
