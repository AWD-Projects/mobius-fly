                                ...
                                {flight.flight_type === "ROUND_TRIP" && flight.return_departure_datetime && (
                                    <>
                                        ...
                                        <div className="flex flex-col gap-1.5">
                                            ...
                                            <div className="flex items-center gap-2">
                                                <span className="text-small font-bold text-text">{flight.arrival_airport.iata_code}</span>
                                                <span className="text-muted text-small">→</span>
                                                <span className="text-small font-bold text-text">{flight.departure_airport.iata_code}</span>
                                            </div>
                                            <span className="text-text font-medium text-small">{fmtDayDate(flight.return_departure_datetime)}</span>
